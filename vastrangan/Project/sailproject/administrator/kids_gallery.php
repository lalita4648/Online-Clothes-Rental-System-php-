...
mysql_select_db($mysql_database, $bd) or die("Opps some thing went wrong");
	...
	if($_SERVER["REQUEST_METHOD"] == "POST")
	{
			  ...
			  $type1 = $_FILES['gallery_small']['type'];
				...
				$sql_gallery="insert into kids_gallery values('','$image_title','$image_description','$gallery_small')";
...
?>
 <div class="container_12"><strong>Kids Costumes >></strong></div>
<div style="height:550px; overflow-y:scroll;overflow-x:hidden; width:818px; margin-left:250px; margin-right:38px;">
<table width="00" border="2" align="center" cellpadding="4" cellspacing="0">
<tr bgcolor="#e4e4e4">
...
<?php           $search_res1=mysql_query("SELECT * from kids_gallery") or die(mysql_error());
         ...
         <tr>
          ...
          <td id="border_half" align="center"><a  href='delete.php?kid=<?PHP echo $rows['id'];?>' onclick="return confirm(&quot;Are you sure you want to delete this item?&quot;);">Delete</a></td>
       </tr>						  
				<?php }?>
