...
mysql_select_db($mysql_database, $bd) or die("Opps some thing went wrong");
	if($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		//$search_res_gallery =mysql_query("SELECT * from men_gallery where ( gallery_small_image='$gallery_small') ");
	  ...
	  //if(1)
		//{
				...
				$sql_gallery="insert into men_gallery values('','$image_title','$image_description','$gallery_small')";
...
?>
 <div class="container_12"><strong>Men Costumes >></strong></div>
<div style="height:550px; overflow-y:scroll;overflow-x:hidden; width:818px; margin-left:250px; margin-right:38px;">
<table width="800"  height="1000" border="2" align="center" cellpadding="4" cellspacing="0">
<tr bgcolor="#e4e4e4">
...
<?php           $search_res1=mysql_query("SELECT * from men_gallery") or die(mysql_error());
         ...
         <tr>
          ...
          <td id="border_half" align="center"><a  href='delete.php?mid=<?PHP echo $rows['id'];?>' onclick="return confirm(&quot;Are you sure you want to delete this item?&quot;);">Delete</a></td>
       </tr>						  
				<?php }?>
