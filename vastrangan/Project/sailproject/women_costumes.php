...
<!--=======content================================-->
        ...
        <div class="white_bg">
            <div class="container_12">
                <div class="container_12"><span style="font-size:30px; font-family:Lucida Calligraphy; color:#FF0000;"><strong>Women Costumes >></strong></span> <a href="contact_us.php" id="link" onclick=""><span style="border:1px solid #461119; color:#fff; background-color:#C74162;">&nbsp;<strong>New Order</strong>&nbsp;</a>   
                <div class="grid_12">
                <?php 
			
				$search_gallery = mysql_query("SELECT * from women_gallery") or die(mysql_error());
				 $i=0;
                   ...
                   <div class="grid_3 alpha">
                        <a href="#" class="img1">
                           ...
                           <img src="administrator/upload_data/<?php echo $rows_gallery['gallery_small']; ?>" border="0" style="margin:10px;"/>
							...
							<a href="women_costumes.php?id=<?php echo $rows_gallery['id'] ;?>" id="link" onClick=""><span style="border:1px solid #461119; color:#fff; background-color:#C74162;">&nbsp;<strong>RENT</strong>&nbsp;</a>   
                        <p class="fs_14"><span class="bold"><a href="#"><?php echo $rows_gallery['image_title'];?></a></span><br><?php echo $rows_gallery['image_description'];?></p>
                    </div>
