...
$email = $_POST['email'];
$insert = "INSERT INTO sb_member values('','$first_name','$last_name','$phone_no','$password','$email')";
...
<form action="#" method="post" enctype="multipart/form-data" onSubmit="return invalid()" name="form">
  <table width="450" border="0" cellspacing="2" cellpadding="2" align="center" bgcolor="#fff">
    <tr>
      <td colspan="3"><span style="font-size:20px; font-family:Lucida Calligraphy; color:#FF0000;"><strong><u>Please Fill the Following Details : ( Registration Form )</u></strong></span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
