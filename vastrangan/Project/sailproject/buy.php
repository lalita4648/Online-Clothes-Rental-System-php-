    ...
    if($email != $row['email'])
 			{
               ...
               $sql="insert into sb_contact values('','$id','$date','$quantity','$days','$email','$phone')";
                ...
                <div class="grid_12">
                    ...
                    <nav>
                        <ul class="sf-menu header_menu">
                            ...
                            <li><a href="#" class="current"><span></span>Costumes<strong></strong></a>
                                <ul class='submenu'>
...
<!--=======content================================-->
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td><span style="font-size:20px; font-family:Lucida Calligraphy; color:#FF0000;"><strong>  Buy Now :</strong></span> <br/>
	<span style="font-size:12px; font-family:Lucida Calligraphy;"><strong>To become a proud owner of pieces from our collection, please fill up the form below and send us a message with the product code(s) you would like to buy, we will get in touch with you shortly for payment details. We offer free delivery within Mumbai and Rs.200/- shipping charges are applicable for shipments elsewhere in India. International shipping rates available on request. Handling time for shipments within India is 7 working days, and for international shipments it is 10 working days. </strong></span> <br/>
                        ...
                        <div class="grid_8 alpha">
                            <nav>
                                <ul class="sf-menu">
                                    ...
                                    <li><a href="#" class="current"><span></span>Costumes</a></li>
                                    <ul class='submenu'>
                                    <li><a href="men_costumes.php">Men Costumes</a></li>
                                    <li><a href="women_costumes.php">Women Costumes</a></li>
